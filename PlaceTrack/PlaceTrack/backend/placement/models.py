...
class Student(models.Model):
    ...
    placement_status = models.CharField(max_length=30, default="Not Placed")
...
class PlacementDrive(models.Model):
    company = models.ForeignKey(
        Company, on_delete=models.CASCADE, related_name="drives"
    )
    job_role = models.CharField(max_length=120)
    package = models.DecimalField(max_digits=7, decimal_places=2)
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=["student", "placement_drive"], name="unique_student_drive"
            )
        ]
...
class Placement(models.Model):
    ...
    company = models.ForeignKey(
        Company, on_delete=models.CASCADE, related_name="placements"
    )
    placement_drive = models.ForeignKey(
        PlacementDrive, on_delete=models.CASCADE, related_name="placements"
    )
    job_role = models.CharField(max_length=120)
    package = models.DecimalField(max_digits=7, decimal_places=2)
